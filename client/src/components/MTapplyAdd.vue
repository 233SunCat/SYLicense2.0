                ...
                <div style="display: flex; justify-content: center; align-items: center;  height: 100%;width: 100%;">
                    <el-form class="demo-form-inline" :label-position="labelPosition" label-width="120px"
                        ...
                        <el-form-item label="样机申请方：">
                            <el-input style="width: 100%;" v-model="formInline.applyName" placeholder="样机申请方" clearable />
                        </el-form-item>
                        <el-form-item label="样机使用用户：">
                            <el-input style="width: 100%;" v-model="formInline.usedName" placeholder="样机使用用户" clearable />
                        </el-form-item>
                        <el-form-item label="样机用途：">
                            <el-select style="width: 100%;" v-model="formInline.equipmentFunction" placeholder="样机用途"
                                clearable>
...
var checkedCities = ref(['实物训练', '基础技能训练'])
...
const getModule = () => {//模块|用途|设备名称
    //多选框
    checkedCities.value = ['实物训练', '基础技能训练']
