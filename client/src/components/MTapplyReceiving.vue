                    ...
                    <el-form class="demo-form-inline" :label-position="labelPosition" label-width="120px"
                        ...
                        <el-form-item label="收货方">
                            <el-row :gutter="5" style="width: 100%">
                                <el-col :span="10">
                                    <el-input style="width: 100%" v-model="formInline.receivingName" placeholder="收货人姓名"
                                        clearable :disabled="disabled" />
                                </el-col>
                                <el-col :span="13">
                                    <el-input style="width: 100%" v-model="formInline.receivingPhone" placeholder="收货人手机号"
                                        clearable :disabled="disabled" />
                                </el-col>
                            </el-row>
                        </el-form-item>
                        <el-form-item label="收货城市/机构" :disabled="disabled">
                            <el-row :gutter="20">
                                <el-col :span="12">
                                    <el-select v-model="formInline.receivingCity" placeholder="发货城市" clearable
                                        :disabled="disabled">
                                ...
                                <el-col :span="8">
                                    <el-select v-model="formInline.receivingCompany" placeholder="发货机构" clearable
                                        :disabled="disabled">
                        ...
                        <el-form-item label="详细收货地址">
                            <el-input style="width: 100%" v-model="formInline.receivingCity_q" placeholder="输入收货地址"
                                clearable :disabled="disabled" />
                        </el-form-item>
...
const onSubmit = () => {
    ...
    axiosServer.AxiosPost(qs.stringify(formInline), '/Model/AddMTapplyReceiving').then(res => {
        if (res.success == true) {
...
const dataInit = () => {
    console.log('加载',formInline)
    var  val = {applyDateApply:formInline.applyDateApply,applyNameApply:formInline.applyNameApply}
    axiosServer.AxiosPost(val, '/Model/GetMTapplyReceiving').then(res => {//res = [],如果id存在[{}...]，id不存在[]
        console.log('res', res)
